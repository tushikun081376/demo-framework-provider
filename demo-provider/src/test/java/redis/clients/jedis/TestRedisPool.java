...
public class TestRedisPool {
	...
	public void testString() {
		...
		/**
		 * append(key,value) 向key为name的值后面加上数据 ---拼接
		 */
		...
		/**
		 * incr(key) 用于将键的整数值递增1。如果键不存在，则在执行操作之前将其设置为0。
	...
	public void testMap() {
		/**
		 * hdel(byte[] key,Map<byte[],byte[]>)
		 * hmset(String key,Map<String,String>)
		 * 添加数据
		 */
	...
	public void testList() {
		...
		System.out.println("javaFramework:"
				+ jedis.lrange("javaFramework", 0, -1));
